          ...
          >
            <div className="space-y-4">
              <Controller
                ...
                name="name"
                render={({ field }) => (
                  <Input {...field} placeholder="Task name" disabled={loading} />
                )}
              />
              <Controller
                control={control}
                name="description"
                render={({ field }) => (
                  <Input {...field} placeholder="Task description" disabled={loading} />
                )}
              />
              <div className={cx("rounded-lg border p-2 focus-within:border-violet-500", {"border-gray-300 bg-gray-100 text-gray-300 pointer-events-none": loading})}>
