...
>(function ResizableTextArea(props, ref) {
  ...
  const [autoSizeStyle, setAutoSizeStyle] = React.useState<CSSProperties>()
  ...
  useLayoutEffect(() => {
    ...
    } else if (resizeState === RESIZE_MEASURING && textareaRef.current) {
  ...
  const cleanRaf = () => {
    if (resizeRafRef.current) raf.cancel(resizeRafRef.current)
  }
