...
import findDOMNode from "~/ui/Col-ui/Virtual-list/utils/findDOMNode"
import raf from "~/ui/Col-ui/Virtual-list/utils/raf"
...
export default function useHeights<T>(
  ...
  const collectRafRef = useRef<number | null>(null)
